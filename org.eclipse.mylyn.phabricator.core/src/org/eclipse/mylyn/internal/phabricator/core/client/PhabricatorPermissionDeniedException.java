 ...
 */
public class PhabricatorPermissionDeniedException extends PhabricatorException {

	private static final long serialVersionUID = -6128773690643367414L;

	public PhabricatorPermissionDeniedException() {
	}

	public PhabricatorPermissionDeniedException(String message) {
		super(message);
	}
